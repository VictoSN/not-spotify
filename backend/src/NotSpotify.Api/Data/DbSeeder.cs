...
public static class DbSeeder
{
    ...
    public static async Task SeedAsync(IServiceProvider sp)
    {
        ...
        // a fresh Supabase database). Idempotent: only resets when the password has drifted.
        ...
        var albums = new[]
        {
            new Album { Id = G("album-1"), ArtistId = artists[0].Id, Title = "Tidal Drift",        Type = "album",  CoverUrl = "https://picsum.photos/seed/album1/300/300", ReleaseDate = new DateOnly(2023, 6, 15),  TotalTracks = 10, DurationMs = 2_580_000, Label = "Dreamgate Records", Copyright = "© 2023 Dreamgate Records", Country = "US", Popularity = 82 },
            new Album { Id = G("album-2"), ArtistId = artists[1].Id, Title = "Ruins & Resonance", Type = "album",  CoverUrl = "https://picsum.photos/seed/album2/300/300", ReleaseDate = new DateOnly(2022, 11, 3),  TotalTracks = 8,  DurationMs = 3_120_000, Label = "Cascade Music",     Copyright = "© 2022 Cascade Music",     Country = "US", Popularity = 74 },
            new Album { Id = G("album-3"), ArtistId = artists[2].Id, Title = "Golden Hours",      Type = "album",  CoverUrl = "https://picsum.photos/seed/album3/300/300", ReleaseDate = new DateOnly(2024, 2, 14),  TotalTracks = 12, DurationMs = 2_940_000, Label = "Velvet Sound",      Copyright = "© 2024 Velvet Sound",      Country = "GB", Popularity = 91 },
            new Album { Id = G("album-4"), ArtistId = artists[3].Id, Title = "Tape Hiss Diaries", Type = "ep",     CoverUrl = "https://picsum.photos/seed/album4/300/300", ReleaseDate = new DateOnly(2024, 5, 20),  TotalTracks = 5,  DurationMs = 1_200_000, Label = null,                Copyright = null,                       Country = "CA", Popularity = 58 },
            new Album { Id = G("album-5"), ArtistId = artists[4].Id, Title = "Drive Forever",     Type = "album",  CoverUrl = "https://picsum.photos/seed/album5/300/300", ReleaseDate = new DateOnly(2023, 10, 31), TotalTracks = 9,  DurationMs = 2_700_000, Label = "Neon Prism",        Copyright = "© 2023 Neon Prism",        Country = "AU", Popularity = 87 },
        };
