    ...
    <div style={{ background: heroGradient(heroColor) }}>
      <div className="flex flex-col sm:flex-row sm:items-end gap-4 sm:gap-6 p-4 sm:p-6 pb-4">
        {showCoverImage ? (
          ...
          <div className="flex w-36 h-36 sm:w-44 sm:h-44 md:w-52 md:h-52 flex-shrink-0 items-center justify-center self-center rounded-md bg-elevated text-secondary shadow-2xl sm:self-auto">
