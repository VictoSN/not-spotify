...
export function FriendPanel({ onClose = () => {}, embedded = false }: FriendPanelProps) {
  ...
  return (
    <div className={embedded
      ? 'spotify-scrollbar sidebar-hover-scrollbar h-full overflow-y-auto py-2'
      : 'spotify-scrollbar absolute right-0 top-full z-[1000] mt-2 max-h-[520px] w-80 overflow-y-auto rounded-md border border-secondary/10 bg-elevated py-2 shadow-2xl'
    }>
