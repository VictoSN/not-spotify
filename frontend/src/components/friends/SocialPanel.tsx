...
export function SocialPanel() {
  ...
  return (
    <aside
      ...
      className={cn(
        'fixed inset-x-2 bottom-20 top-[4.5rem] z-40 flex flex-col overflow-hidden rounded-xl border border-secondary/10 bg-surface shadow-2xl md:left-auto md:w-96 lg:relative lg:inset-auto lg:z-auto lg:shrink-0 lg:rounded-lg lg:border-0 lg:shadow-none',
